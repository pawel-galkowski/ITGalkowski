...
describe("Footer Component", () => {
  it("renders footer with copyright text", () => {
    ...
    expect(screen.getByText(new RegExp(String.raw`© ${currentYear}.*All Rights Reserved`))).toBeInTheDocument();
  });
  ...
  it("displays company name in copyright", () => {
    ...
    expect(contentinfo.textContent).toMatch(/All Rights Reserved/);
  });
