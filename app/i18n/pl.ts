...
export const pl: Translations = {
  ...
  tiles: {
    header: "Innowacyjne tworzenie stron internetowych na Śląsku",
  },
  experience: {
    header: "Moja ścieżka zawodowa",
  },
  entrySection: {
    title: "Opanuj swoje projekty dzięki profesjonalnemu kodowi",
    body: "Wzbogać swoje projekty dzięki profesjonalnym rozwiązaniom full-stack JavaScript w Katowicach. Odkryj płynną integrację i najnowocześniejsze innowacje",
    button: "Zatrudnij eksperta",
  },
