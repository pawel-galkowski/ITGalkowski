...
describe('Faqs Component', () => {
  ...
  it('displays first FAQ question', () => {
    render(<Faqs />)
    expect(screen.getByText(/What services do you offer as a full-stack JavaScript engineer/)).toBeInTheDocument()
  })

  it('displays all FAQ questions', () => {
    render(<Faqs />)
    expect(screen.getByText(/What services do you offer as a full-stack JavaScript engineer/)).toBeInTheDocument()
    expect(screen.getByText(/Which JavaScript frameworks do you specialize in/)).toBeInTheDocument()
